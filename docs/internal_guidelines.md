...
4) Code generation  
   ...
   - For runnable Python deliverables, always generate `main.py` as the entrypoint (with `main()`) and provide `pyproject.toml` (Python 3.13; dependencies managed via uv/configurable settings).
